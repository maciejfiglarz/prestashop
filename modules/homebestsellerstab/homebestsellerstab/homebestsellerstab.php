...
class homebestsellerstab extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Featured best sellers products tab');
            ...
            <div id="module_block_settings">
                    <fieldset id="fieldset_modu\le_block_settings">
                        ...
                        <form action="' . $_SERVER['REQUEST_URI'] . '" method="post">
                            ...
                            <div class="margin-form">' . (Tools::isSubmit('submit_settings_updates_now') ? (homebestsellerstabUpdate::inconsistency(0) ? '' : '') . $this->checkforupdates(1) : '') . '
        ...
        else
        {
            if (defined('_PS_ADMIN_DIR_'))
            {
                ...
                if (Configuration::get('mypresta_updates') != 0 || (bool)Configuration::get('mypresta_updates') == false)
                {
                    ...
                    {
                        $actual_version = homebestsellerstabUpdate::verify($this->name, (isset($this->mkey) ? $this->mkey : 'nokey'), $this->version);
                    }
                    if (homebestsellerstabUpdate::version($this->version) < homebestsellerstabUpdate::version(Configuration::get('updatev_' . $this->name)))
                    {
                ...
                if ($display_msg == 1)
                {
                    if (homebestsellerstabUpdate::version($this->version) < homebestsellerstabUpdate::version(homebestsellerstabUpdate::verify($this->name, (isset($this->mkey) ? $this->mkey : 'nokey'), $this->version)))
                    {
    ...
    {
        if (!$this->isCached('homebestsellerstab.tpl', $this->getCacheId('homebestsellerstab')))
        {
...
class homebestsellerstabUpdate extends homebestsellerstab
{
